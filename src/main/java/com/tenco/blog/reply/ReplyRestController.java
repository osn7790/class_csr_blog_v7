...
public class ReplyRestController {
    ...
    public ResponseEntity<?> save (@Valid @RequestBody ReplyRequest.SaveDTO saveDTO, Errors error, @RequestAttribute(Define.SESSION_USER) SessionUser sessionUser) {
    ...
    public ResponseEntity<ApiUtil<String>> delete(@PathVariable(name = "id") Long replyId, @Valid
                         @RequestParam(name = "boardId") Long boardId, Errors Error,
